...
// SDIMenuDoc.cpp : CSDIMenuDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CSDIMenuDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CSDIMenuDoc::InitializeSearchContent()
{
...
void CSDIMenuDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
